...
- **Remaining: Tier 2 #6** founder + scientific-advisor Person entities — BLOCKED on the advisor's real data (full name, affiliation, ORCID, role). Then **Tier 3** (glossary split, evidence-vs-philosophy separation, entity tightening, outcome data [needs real pilot data], monitoring).
