...
- **Next: Tier 3** — evidence-vs-philosophy separation (#11), entity tightening (#12), outcome data (#13, needs real pilot data), monitoring (#14). Also pending: Tier 2 #6 advisor half (needs Valentin's real data).
