...
- **Next: Tier 2** — founder + advisor entities (#6), ONDA-vs-alternatives (#7), /product (#8), FAQ hub (#9). (Evidence Center can later grow more claims/refs — the dataset is built for it.)
