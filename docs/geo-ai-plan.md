...
- **Next: Tier 2** — founder + advisor entities (#6, needs advisor's real data: full name, affiliation, ORCID), /product (#8), FAQ hub (#9). (Evidence Center + ONDA-vs datasets both built to grow with one entry each.)
