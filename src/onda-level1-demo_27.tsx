...
const OndaLevel1 = () => {
      ...
      <div className={`min-h-screen bg-gradient-to-br ${activePractice.colors} text-white relative overflow-hidden transition-all duration-1000`}>
        ...
        {practiceState === 'active' && (
          <div className="relative z-10 flex flex-col items-center justify-center min-h-screen p-3 sm:p-6">
            <div className="text-5xl sm:text-9xl mb-6 sm:mb-16 transition-all duration-1000" style={{
  ...
  return (
    <div className={`h-full text-white overflow-x-hidden transition-all duration-1000 ${
      ...
      {/* Верхняя навигация */}
      <div className={`bg-black/10 backdrop-blur-xl border-b pt-4 transition-all duration-1000 ${
        activeCircuit === 2
          ? 'border-cyan-500/20'
          : activeCircuit === 3
          ? 'border-gray-500/20'
