  ...
  return (
    ...
    <div className={`fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4 overflow-y-auto ${selectedPractice ? 'hidden' : ''}`}>
      <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-3xl max-w-lg w-full shadow-2xl border border-white/10 overflow-hidden my-4">
        <div className="relative bg-gradient-to-r from-indigo-600 to-purple-600 p-3 sm:p-4" style={{ paddingTop: 'max(12px, env(safe-area-inset-top))' }}>
          <button
            onClick={onClose}
          ...
          <p className="text-indigo-100 text-xs sm:text-sm text-center">{t('emotional_check.subtitle')}</p>
        </div>
        ...
        <div className="p-3 sm:p-4 space-y-3 sm:space-y-4">
          ...
          {recordingState === 'result' && emotionalResult && (
            <div className="space-y-2 sm:space-y-3">
              <div className={`bg-gradient-to-br ${getEmotionColor(emotionalResult.primaryEmotion)} rounded-2xl p-3 sm:p-4 text-white`}>
                <div className="text-center mb-2 sm:mb-3">
                  <div className="text-4xl sm:text-5xl mb-1">🎭</div>
                  <h3 className="text-xl sm:text-2xl font-bold mb-0.5">{t(emotionalResult.primaryEmotion)}</h3>
                  <p className="text-white/90 text-xs sm:text-sm">{t('emotional_check.detected_state')}</p>
                </div>

                <div className="space-y-2 bg-white/10 backdrop-blur-sm rounded-xl p-2.5 sm:p-3">
                  <div>
              ...
              <div className="bg-slate-800/50 rounded-xl p-3 sm:p-4 border border-white/10">
                <h4 className="text-white font-semibold mb-1.5 flex items-center gap-2 text-sm sm:text-base">
                  <span>💡</span>
              ...
              <div className="space-y-1.5 sm:space-y-2">
                <h5 className="text-white/70 text-xs sm:text-sm font-semibold text-center">
                ...
                <div className="grid grid-cols-3 gap-1.5 sm:gap-2">
                  {getAdaptivePractices(emotionalResult.primaryEmotion).map((practice, index) => (
                    <button
                      ...
                      className="bg-slate-800/50 hover:bg-slate-700/50 text-white text-xs py-2 px-2 sm:px-3 rounded-lg transition-all border border-white/10 hover:border-white/20 hover:scale-105"
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-500 hover:to-cyan-500 text-white font-semibold py-2.5 sm:py-3 px-4 rounded-xl transition-all flex items-center justify-center gap-2 text-xs sm:text-sm"
              ...
              <button
                onClick={reset}
                className="w-full bg-gradient-to-r from-slate-700 to-slate-600 hover:from-slate-600 hover:to-slate-500 text-white font-semibold py-2.5 sm:py-3 px-4 rounded-xl transition-all flex items-center justify-center gap-2 text-xs sm:text-sm"
              >
                <RefreshCw className="w-4 h-4 sm:w-5 sm:h-5" />
