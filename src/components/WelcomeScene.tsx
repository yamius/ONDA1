...
const buildExrMap = (): Record<string, string> => {
...
export const PRACTICE_EXR: Record<string, string> = buildExrMap()
...
const buildJpegMap = (): Record<string, string> => {
  const map: Record<string, string> = {}
  for (const part of [1, 2, 3])
...
export const PRACTICE_JPEG_PREVIEW: Record<string, string> = buildJpegMap()
