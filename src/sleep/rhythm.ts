 ...
 * 3. Считаем streak дней подряд с оптимальным сном (6-8 часов)
 * 4. При streak >= 7 дней → артефакт активен → +100% OND
 *
 * Условие "хорошего" дня: сон от 6 до 8 часов (время не важно)
 */
...
const MIN_DURATION_MIN = 300;    // Минимум 5 часов (для fallback качества "fair")
const OPTIMAL_SLEEP_MIN = 360;   // Оптимум 6 часов
const OPTIMAL_SLEEP_MAX = 480;   // Максимум 8 часов
...
export const rhythmStore = {
   ...
   *
   * Условие "хорошего" дня: сон от 6 до 8 часов (360-480 мин).
