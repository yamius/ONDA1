...
## Блоки контента (на примере Части 3)

| Блок | Описание | Где в коде |
|------|----------|------------|
| **B_1** | Эпиграф/философская цитата | `philosophy.level_N.quote` (опционально) |
| **B_2** | Заголовок + краткое описание | `circuits.circuit_N_name`, `circuits.circuit_N_subtitle` |
| **B_3** | Поэтический вступительный текст | `philosophy.level_N.text_1` ... `text_6` |
| **B_4** | Расширенное описание/философия | `level_goal.level_N.wisdom_1` ... `wisdom_4` |
| **B_5** | Цитаты элемента (TERRA/AQUA) | `level_goal.level_N.wisdom_1-4` или отдельный блок |
| **B_6** | Финальное напутствие | `final_phrases.pN_M` (для каждой практики) |
