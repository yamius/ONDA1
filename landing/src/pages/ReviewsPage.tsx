...
import { reviews, comparisons } from '../data/reviews'
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 pb-16 pt-6 md:px-6">
      ...
      <p className="mb-6 max-w-2xl font-mono text-sm leading-relaxed text-white/50">
        Independent, criteria-based reviews of HRV trackers and wearables — scored
        on measurement accuracy, data access and real-world use, not on hype.
      </p>
      <Link
      ...
      {reviews.length > 0 ? (
        ...
        <section className="border-t border-white/5 pt-10">
          <p className="font-mono text-sm text-white/30">
            First reviews are in the lab — published as testing completes.
          </p>
        </section>
      )}
    </div>
