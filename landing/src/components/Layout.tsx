    ...
    <div className="min-h-screen bg-[#050a0f] text-white">
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#050a0f]/90 backdrop-blur-md">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 md:px-6 md:py-4">
          ...
          <a
            href="#download"
            className="rounded-lg bg-gradient-to-r from-cyan-500 to-green-500 px-4 py-2 text-xs font-bold text-black transition-all hover:from-cyan-600 hover:to-green-600 md:hidden"
          >
            Download App
          </a>
        </div>
        ...
        {/* Mobile menu overlay */}
        {menuOpen && (
          <div className="fixed inset-0 top-[56px] z-40 bg-[#050a0f]/95 backdrop-blur-lg md:hidden">
            <div className="flex flex-col px-6 py-8">
              <Link
                to="/"
                className="border-b border-white/5 py-4 text-lg font-medium text-white/80 transition-colors hover:text-white"
              >
                About
              </Link>
              <Link
                to="/glossary"
                className={`border-b border-white/5 py-4 text-lg font-medium transition-colors hover:text-white ${
                  location.pathname.startsWith('/glossary') ? 'text-cyan-400' : 'text-white/80'
                }`}
              >
                Glossary
              </Link>
              <button
                className="border-b border-white/5 py-4 text-left text-lg font-medium text-white/80 transition-colors hover:text-white"
              >
                Language
              </button>
              <a
              ...
              <a
                ...
                className="py-4 text-lg font-medium text-white/80 transition-colors hover:text-white"
              >
                Contacts
              </a>
              ...
              <div className="mt-8 flex flex-col gap-3">
                <a
                  href="#"
                  className="flex items-center justify-center gap-2 rounded-lg border border-white/10 bg-white/5 px-5 py-3 text-sm text-white/50 transition-all hover:border-white/20"
                >
