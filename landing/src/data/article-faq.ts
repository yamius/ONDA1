...
export const ARTICLE_FAQ: Record<string, { question: string; answer: string }[]> = {
  ...
  "talk-to-your-doctor-about-wearable-data": [
    { question: "Should I show my doctor my smartwatch data?", answer: "Yes, if it's summarized. Doctors find trends, dates and context useful — especially resting heart rate, sleep patterns and any medically cleared alerts. A one-page summary works far better than raw exports or brand scores." },
    { question: "Do doctors take HRV seriously?", answer: "HRV isn't a routine clinical measurement for most people, and single readings are hard to interpret. A sustained change against your own baseline, alongside symptoms, is more meaningful than any one number." },
    { question: "What watch data is most useful to a doctor?", answer: "Resting heart rate trends, sleep duration and timing, dated events, any regulator-cleared alerts your watch provides, and your own notes on symptoms and life events." },
    { question: "How much data should I bring?", answer: "Four to eight weeks of trends on one page, with your baseline, what changed and when, and your questions. More isn't better — clarity is." },
    { question: "Can my watch data replace a medical test?", answer: "No. It can point to a question worth asking, but it isn't a diagnosis. Your doctor decides which tests you actually need." },
  ],
  "onda-report-for-your-gp": [
    { question: "Will my GP understand HRV data?", answer: "Many GPs don't use HRV in routine care, and that's fine. What they can use is the change against your own baseline — especially resting heart rate — alongside your symptoms, medications and notes." },
    { question: "What can a GP do with my watch data?", answer: "Match a change to everyday causes like infection, medication, sleep or alcohol; decide whether tests such as bloods or an ECG are worth doing; refer you to a specialist if needed; and use your trend to follow up." },
    { question: "Should I see a GP or a specialist first?", answer: "Usually a GP. They see your whole history, rule out common causes, and refer you to the right specialist only if needed — with your report as the starting point." },
    { question: "How much data should I show my GP?", answer: "Four to eight weeks on one page: your baseline, what changed and when, your notes and your questions." },
    { question: "Can a GP diagnose something from my watch data?", answer: "No. Watch data can prompt a question, but diagnosis comes from examination and tests your doctor decides you need." },
  ],
  "onda-report-for-your-cardiologist": [
    { question: "Will a cardiologist use my smartwatch heart-rate data?", answer: "Many will look at it as context — especially resting heart rate trends and dated episodes matched to symptoms. It helps them choose and time the right test, but it doesn't replace an ECG or other cardiac tests." },
    { question: "Can heart-rate trends detect arrhythmias?", answer: "No. Pulse trends can't show the heart's rhythm. Only ECG-type recordings — a clinic ECG, a Holter or event monitor, or a medically cleared watch ECG feature — can show the rhythm itself." },
    { question: "Is HRV useful to a cardiologist?", answer: "In research, reduced HRV is linked to autonomic function and cardiovascular risk. In routine care, consumer-watch HRV isn't diagnostic; a cardiologist may see a sustained change as supporting context only." },
    { question: "What tests might a cardiologist order after seeing my data?", answer: "Depending on symptoms: an ECG, a Holter or longer-term rhythm monitor, a heart ultrasound (echocardiogram) or an exercise test. Your data helps judge which one and for how long." },
    { question: "Can I use my watch to monitor a known heart condition?", answer: "Only as a supplement, and only as your cardiologist advises. Their prescribed monitoring and treatment plan always come first." },
  ],
  "onda-report-for-your-sleep-specialist": [
    { question: "Is smartwatch sleep data useful to a sleep specialist?", answer: "Yes, as context. Weeks of sleep timing, nightly heart rate, HRV and breathing reveal patterns — irregular schedules, nights the body didn't settle — that help point to the type of sleep problem. It doesn't replace a clinical sleep assessment." },
    { question: "Can my watch detect sleep apnea?", answer: "A breathing app's trends can't diagnose sleep apnea. Some watches offer a separately cleared sleep apnea notification feature; if yours alerted you, tell your doctor. Diagnosis requires a home sleep apnea test or an overnight sleep study." },
    { question: "What is orthosomnia?", answer: "Becoming so focused on perfect sleep data that the anxiety worsens sleep. Use your data to see patterns over weeks, not to grade each night — and check less if it makes you anxious." },
    { question: "What treatment works for chronic insomnia?", answer: "The recommended first-line treatment is cognitive behavioral therapy for insomnia (CBT-I), delivered by a trained clinician or structured program. A sleep specialist can guide you to it." },
    { question: "What tests might a sleep specialist order?", answer: "Depending on symptoms: questionnaires, a sleep diary, a home sleep apnea test or an overnight sleep study (polysomnography), which measures breathing, oxygen and sleep stages directly." },
  ],
  "onda-report-for-your-sports-doctor": [
    { question: "Can resting heart rate and HRV show overtraining?", answer: "They can suggest poor recovery — especially a resting heart rate that stays elevated and HRV that stays low for days, alongside fatigue and poor performance. They can't diagnose overtraining syndrome; a sports doctor combines trends with symptoms, examination and sometimes tests." },
    { question: "What might a sports doctor check if my recovery is poor?", answer: "Beyond the training plan, possible medical causes such as iron deficiency, thyroid problems or low energy availability (RED-S), which need examination and blood tests." },
    { question: "When is it safe to train again after being ill?", answer: "When you feel well, have no fever, and your doctor agrees. A resting heart rate returning to your normal range is one supportive sign, not a green light on its own. Return gradually." },
    { question: "Is wrist heart rate accurate during exercise?", answer: "Less so during intense or irregular efforts like intervals and strength training. Resting and overnight readings are more reliable for recovery trends." },
    { question: "Should I adjust training based on daily HRV?", answer: "Some athletes do, and research suggests HRV-guided training can help individualize load. Look at trends rather than single days, and discuss it with a coach or sports doctor." },
  ],
  "doctors-and-your-data": [
    { question: "Which doctor should I show my smartwatch data to?", answer: "Usually your GP first. They see your whole history, rule out everyday causes and refer you to a specialist — cardiologist, sleep specialist, psychiatrist or sports doctor — only if needed." },
    { question: "Do doctors take wearable data seriously?", answer: "Increasingly, when it's summarized: trends, dates, context and symptoms. Raw exports and brand scores are hard to use; a one-page summary works much better." },
  ...
  "onda-report-for-your-neurologist": [
    { question: "Can my smartwatch detect POTS?", answer: "No. A watch may show a pattern — like a sharp heart rate rise when you stand — that's worth raising with a doctor, but POTS is diagnosed with measured heart rate and blood pressure lying and standing, under clinical conditions." },
    { question: "Why would a neurologist care about my heart rate?", answer: "Because the autonomic nervous system controls your heart rate. Many autonomic disorders show up first as unusual heart rate patterns, even when the heart itself is healthy." },
    { question: "What is the deep-breathing heart rate test?", answer: "A standard autonomic test where you breathe slowly at about six breaths per minute while your heart is recorded. A healthy system makes heart rate rise and fall strongly with breathing; a reduced response can point to impaired vagal control." },
    { question: "Can wearable data help with long COVID?", answer: "It can help document patterns, flares and slow recovery, and some clinicians use heart rate to help patients pace activity. It supports care from a clinician; it doesn't replace it." },
    { question: "Does slow breathing treat dysautonomia?", answer: "No. Slow breathing may help some people feel calmer and steadier, but treatment should come from a clinician and may include fluids, salt, compression, reconditioning and medication." },
  ],
  "onda-report-for-your-endocrinologist": [
    { question: "Can a high resting heart rate be a sign of a thyroid problem?", answer: "It can be. An overactive thyroid often raises resting heart rate, alongside symptoms such as feeling hot, weight loss or palpitations. But many other things raise heart rate too; a blood test is needed to check thyroid function." },
    { question: "Why does HRV matter in diabetes?", answer: "Diabetes can damage the autonomic nerves that control the heart (cardiovascular autonomic neuropathy), and reduced HRV is one of its early features. Doctors diagnose it with clinical autonomic reflex tests, not wearable data." },
    { question: "Can my watch tell me if my blood sugar is low?", answer: "No. Heart rate may rise during a low, but it isn't reliable. Use a glucose meter or continuous glucose monitor as your doctor advises." },
    { question: "Will my resting heart rate change with thyroid treatment?", answer: "Often, yes — it may move back toward your normal range as thyroid levels are corrected. Dosing, however, is always based on blood tests and your doctor's judgment." },
    { question: "Which tests might an endocrinologist order?", answer: "Depending on symptoms: thyroid blood tests, glucose and HbA1c, and in diabetes with signs of nerve involvement, cardiovascular autonomic reflex tests." },
  ],
  "onda-report-for-your-gynecologist": [
    { question: "Does resting heart rate change during the menstrual cycle?", answer: "Often, yes. On average, resting heart rate rises by a few beats and HRV falls after ovulation, returning at the next period. The size of the change varies widely, and some women — especially on hormonal contraception — see little difference." },
    { question: "Is a higher heart rate before my period normal?", answer: "For many women, yes. Compare it with your own pattern over several cycles. If it comes with heavy bleeding, fatigue or other symptoms, mention it to your doctor." },
    { question: "Can my watch data track ovulation or prevent pregnancy?", answer: "No. Heart-rate and HRV patterns are not a contraceptive or fertility method. ONDA does not predict ovulation." },
    { question: "Is it normal for heart rate to rise during pregnancy?", answer: "Yes, a gradual rise is expected as the body adapts. Your watch is not a pregnancy monitor; follow your prenatal care and seek care for warning symptoms." },
    { question: "Can data help with menopause symptoms?", answer: "It can document hot flashes, night sweats and disturbed sleep over time, helping you and your gynecologist judge the impact and see how treatment changes things." },
  ],
  "onda-report-for-your-pulmonologist": [
    { question: "What is a normal breathing rate at rest?", answer: "For adults, roughly 12 to 20 breaths per minute. Your own night-time rate tends to be stable, so changes from your personal baseline are more meaningful than comparing with the general range." },
    { question: "Can a rising breathing rate mean I'm getting ill?", answer: "It can accompany the start of an infection or a flare of a lung condition, often together with a higher resting heart rate. But it has many causes and can't identify what's wrong on its own." },
    { question: "Do breathing exercises help asthma?", answer: "Breathing retraining delivered by respiratory physiotherapists is recommended in some guidelines as an addition to medication, and a clinical trial showed improved quality of life in asthma. It doesn't replace inhalers or treat attacks." },
    { question: "What is dysfunctional breathing?", answer: "An inefficient breathing pattern — too fast, too high in the chest or through the mouth — that can cause breathlessness even when the lungs are healthy. It's often treated with breathing retraining." },
    { question: "Can my watch detect asthma or COPD?", answer: "No. These are diagnosed with lung function tests. Your data can show patterns and flares over time to discuss with a specialist." },
  ],
  "onda-report-for-your-occupational-health-doctor": [
    { question: "Can my heart rate data show that work is affecting my health?", answer: "It can show patterns — for example, higher resting heart rate and lower HRV on workdays that recover on days off, or no recovery at all during demanding periods. It can't diagnose a condition, but it makes the effect of work visible." },
    { question: "Is burnout a medical diagnosis?", answer: "The World Health Organization describes burnout as an occupational phenomenon caused by unmanaged chronic workplace stress, not as a medical condition in itself. It's still taken seriously because of its effects on health and work." },
    { question: "Which shift patterns are easier on the body?", answer: "Generally, forward-rotating shifts (day → evening → night) with enough recovery time between blocks are easier to adapt to than backward rotations. An occupational health doctor can advise on your specific situation." },
    { question: "Will my employer see my health data?", answer: "It depends on your country and arrangement. Occupational health doctors often share conclusions about fitness for work or adjustments, usually not detailed medical data. Ask before sharing, and share only what you choose." },
    { question: "What helps shift workers sleep?", answer: "Protecting daytime sleep (dark, quiet room), timing light exposure, keeping a regular anchor sleep period and planning recovery between shift blocks. Persistent problems may need a sleep specialist." },
  ],
  "onda-report-for-your-rehabilitation-team": [
    { question: "Can heart rate data help with rehabilitation?", answer: "Yes, as context for pacing. Resting heart rate, HRV and breathing trends — especially the day after activity — help a rehabilitation team judge whether load is right and how recovery is progressing." },
    { question: "Why does the day after exercise matter?", answer: "Because your body's response often shows up later: an elevated heart rate, lower HRV or poor sleep the next night can signal the effort was too much, even if it felt fine. Some post-viral symptoms appear 24–48 hours later." },
    { question: "What heart rate should I exercise at after a heart attack?", answer: "The one your cardiac rehabilitation team sets, usually based on clinical testing and supervision. Some heart medications blunt heart rate, so general charts may not apply to you." },
