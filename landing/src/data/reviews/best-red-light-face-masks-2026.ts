...
const bestRedLightFaceMasks2026: Comparison = {
  slug: 'best-red-light-face-masks-2026',
  title: 'Best Red Light Face Masks (2026)',
  description:
  ...
  picks: [
    ...
    },
    {
      ...
      award: 'Best consumer market leader',
      takeaway: 'Biggest customer base + integrated neck flap + polished silicone build — the consumer default.',
    },
    {
    ...
    },
    {
      ...
      award: 'Best premium spec',
      takeaway: '470 LEDs + three-wavelength coverage + flexible silicone with neck flap — spec maximalist.',
    },
    {
      reviewSlug: 'theraface-mask',
      award: 'Best for Therabody ecosystem',
      takeaway: 'Three-wavelength coverage with app control — leverages Theragun brand crossover.',
    },
    {
    ...
    },
    {
      ...
      award: 'Best multi-wavelength value',
      takeaway: 'Seven wavelength modes from K-beauty engineering at mid-tier $399 pricing.',
    },
    {
      reviewSlug: 'solawave-wand-4-in-1',
      award: 'Best budget entry',
      takeaway: '$169 handheld with red LED + microcurrent + warmth + massage — entry to the category.',
    },
    {
      reviewSlug: 'shark-cryoglow',
      award: 'Best hybrid form factor',
      takeaway: 'Active cooling combined with red + blue LED — novel form factor for puffiness + light.',
    },
  ],
  verdict:
  ...
  faq: [
    ...
    },
    {
      ...
      a: 'Masks deliver passive whole-face dose with no active positioning — better daily-use convenience. Handhelds (LightStim, Solawave) deliver higher per-zone local dose but require active use. Most users start with a mask; clinical evidence base is deeper for handhelds (LightStim has the longest peer-reviewed track record).',
    },
    {
      q: 'What wavelengths should a red light face mask have?',
      a: 'Standard clinical pair is red 633 nm (surface, collagen) + near-infrared 830 nm (deeper tissue). Some masks add blue 415 nm (acne), amber 590 nm (pigmentation) or green. More wavelengths is not strictly better — the standard red + NIR pair has the deepest dermatology evidence base.',
    },
    {
