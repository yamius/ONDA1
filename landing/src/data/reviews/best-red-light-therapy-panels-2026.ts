...
const bestRedLightPanels2026: Comparison = {
  slug: 'best-red-light-therapy-panels-2026',
  title: 'Best Red Light Therapy Panels (2026)',
  description:
    'ONDA ranks the ten best red light therapy panels of 2026 — Joovv, Mito Red, PlatinumLED, GembaRed and more — scored on irradiance, wavelength coverage, EMF and value.',
  intro:
  ...
  picks: [
    ...
    },
    {
      ...
      award: 'Best EMF discipline',
      takeaway: 'Fully-shielded build with the lowest EMF in this list — engineered by an industry founder.',
    },
    {
      reviewSlug: 'rubylx-lyra-pro',
      award: 'Best testing transparency',
      takeaway: 'Every published spec independently lab-verified — the most-tested panel in the consumer category.',
    },
    {
    ...
    },
    {
      ...
      takeaway: 'Four-wavelength mid-size panel under $1,000 with stand and door mount included.',
    },
    {
      reviewSlug: 'hooga-hg500',
      award: 'Best budget pick',
      takeaway: 'Verified two-wavelength specs at $349 — the budget biohacker entry.',
    },
    {
      reviewSlug: 'bon-charge-red-light-panel',
      award: 'Best for EU / AU buyers',
      takeaway: 'Wellness-positioned panel with consistent build from an established EU/AU consumer brand.',
    },
    {
  ...
  faq: [
    ...
    },
    {
      ...
      a: 'Both. 660 nm (red) is the standard for skin and surface tissue; 850 nm (near-infrared) penetrates deeper for muscle and joint use. The biohacker convention is to want both; some panels add 630, 810, 830 or 940 nm for broader coverage. The standard 660 + 850 combo is enough for most use cases.',
    },
    {
