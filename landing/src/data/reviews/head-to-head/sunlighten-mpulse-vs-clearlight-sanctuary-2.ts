...
const sunlightenVsClearlight: HeadToHead = {
  ...
  title: 'Sunlighten mPulse vs Clearlight Sanctuary 2 (2026)',
  description:
  ...
  faq: [
    ...
    },
    {
      ...
      a: 'For most users, marginally. Sunlighten lets you run near-only, mid-only, far-only or combined per session — useful for users specifically tuning wavelength exposure. For typical sauna use, Clearlight’s combined full-spectrum delivers the same downstream benefits.',
    },
    {
      q: 'Is Clearlight lifetime warranty better than Sunlighten 7-year?',
      a: 'On paper yes — but in practice premium IR sauna heaters in either brand rarely fail before 10–15 years. The lifetime warranty is reassurance that the Jacuzzi parent company is unlikely to disappear.',
    },
    {
