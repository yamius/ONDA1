...
const appleWatchVsGarminVenu4: HeadToHead = {
  ...
  intro:
    'Apple Watch Series 11 and Garmin Venu 4 are the two smartwatches non-diabetic biohackers most often weigh against each other when they want HRV without committing to a dedicated ring or strap. They sit at opposite ends of the same hardware category — Apple as the all-purpose computer on the wrist, Garmin as the training-and-recovery instrument with a five-day battery. The right pick is rarely about HRV alone.',
  winnerSlug: null,
  verdict:
  ...
  axes: [
    ...
    { name: 'Battery life', winner: 'b', note: 'Apple Watch: ~18–36h depending on always-on display. Garmin Venu 4: ~5 days smartwatch mode. Garmin runs continuously through the multi-day windows HRV monitoring assumes.' },
    ...
    { name: 'Price', winner: 'b', note: 'Apple Watch Series 11: ~$399. Garmin Venu 4: ~$449. Comparable; Apple slightly cheaper at entry.' },
  ],
  faq: [
    {
    ...
    },
    {
      ...
      a: 'About 5 days in smartwatch mode with continuous HRV, ~3 days with always-on display, less with active GPS workouts. Apple Watch with always-on display is ~18–24h. The battery gap is real, and it matters specifically because HRV is read at night while you sleep.',
    },
    {
