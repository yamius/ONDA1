...
const irVsTraditional: HeadToHead = {
  ...
  productCSlug: 'almost-heaven-salem',
  title: 'Sunlighten vs Finnleo vs Almost Heaven (2026)',
  description:
  ...
  faq: [
    ...
    },
    {
      ...
      a: 'Finnleo makes outdoor configurations but the Hallmark model reviewed here is indoor. For outdoor Finnish-style sauna, Almost Heaven Salem is the right shape. For outdoor Finnleo, look at their Inspiration or Verge models.',
    },
    {
    ...
    },
    {
      ...
      a: 'Traditional convection saunas (Finnleo, Almost Heaven) — no electronics in heat delivery. Sunlighten is documented low-EMF (<1 mG at seated position) but non-zero.',
    },
  ],
