...
const threePremiumSauna: HeadToHead = {
  ...
  productCSlug: 'saunaspace-faraday',
  title: 'Sunlighten vs Clearlight vs SaunaSpace (2026)',
  description:
  ...
  faq: [
    ...
    },
    {
      ...
      a: 'Sunlighten — the brand has the largest published-research footprint in consumer IR sauna by a meaningful margin. Clearlight and SaunaSpace have research presence but smaller volume of device-specific studies.',
    },
    {
      q: 'Are warranties comparable?',
      a: 'Clearlight wins on paper with lifetime heater warranty (Jacuzzi backing). Sunlighten: 7-year. SaunaSpace: 5-year. In practice premium IR sauna heaters in any of these brands rarely fail before 10–15 years.',
    },
  ],
