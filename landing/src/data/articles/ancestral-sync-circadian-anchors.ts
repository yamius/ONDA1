 ...
 * ID: ancestral_sync_02
 * SEO: Circadian anchors, DNA repair schedule, Zeitgeber signals, evolutionary biology, HRV circadian.
 */
...
`,
  howToSteps: [
    {
      name: 'The Photonic Trigger',
      text: 'Get 10 minutes of direct sunlight (not through glass) within the first hour of waking, or use a 10,000-lux therapy lamp.',
      protocolId: 'ancestral_sync_02_photon',
    },
    {
    ...
    {
      name: 'The Metabolic Gate',
      text: 'Eat breakfast at a consistent time every day to lock the peripheral organ clocks (liver, gut, kidneys) into a synchronized metabolic schedule.',
      protocolId: 'ancestral_sync_02_metabolic',
    },
  ],
}
