 ...
 * ID: motor_control_08
 * SEO: rhythmic entrainment CPG synchronization, 0.1 Hz resonance breathing, locomotor respiratory coupling, neural oscillator synchronization, phase desync biohacking.
 */
...
`,
  howToSteps: [
    {
      name: '0.1 Hz Audio/Visual Pacing (Master Clock Injection)',
      text: 'Use ONDA\'s 0.1 Hz pacing cue (6 cycles/minute visual or auditory signal) as breathing anchor for 5–10 minutes. Inhale on rising cue, exhale on falling. Phase-locks the full respiratory-cardiac-thalamic-cortical chain within 5 minutes via the auditory-autonomic pathway.',
      protocolId: 'entrainment-01hz-pacing',
    },
    {
      name: 'Locomotor-Respiratory Coupling (LRC)',
      text: 'During walking or running, lock step rhythm to breath phases: 3–4 steps inhale / 3–4 steps exhale (or 4:6 ratio). Maintain for the first 5–10 minutes until automatic. Phase-locks CPG locomotor output to the respiratory cycle — reduces metabolic overhead and turns movement into master clock reinforcement.',
      protocolId: 'entrainment-lrc',
    },
    {
      name: 'Acoustic Entrainment (Resonant Soundscape)',
      text: 'Use soundscapes calibrated to target oscillator states: slow percussion near 0.1 Hz for respiratory entrainment, isochronic tones 8–12 Hz for Alpha stabilization, or music cadence matched to locomotor frequency. Auditory-motor pathway lowers entrainment activation threshold — system achieves coherence faster with less voluntary effort.',
      protocolId: 'entrainment-acoustic',
    },
  ],
}
