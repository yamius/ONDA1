 ...
 * ID: fluid_dynamics_02
 * SEO: cerebrospinal fluid flow, glymphatic hydraulics, intracranial pressure, vascular pulsatility brain, CSF drainage optimization.
 */
...
`,
  howToSteps: [
    {
      name: 'Vascular Priming (Arterial Piston Prep)',
      text: '10–15 minutes of evening contrast therapy (alternating 30s warm / 30s cool water, ending cold) or light aerobic movement at 60–70% max HR, 2–3 hours before sleep. Increases arterial elasticity and CSF pump stroke amplitude for the nightly purge.',
      protocolId: 'neural-hydraulics-vascular-priming',
    },
    {
      name: 'Gravity Hack (Hydrostatic Outflow Optimization)',
      text: 'Default sleep position: lateral (left or right side). Use body pillow to prevent rollover. Head angle 15–20° if using wedge. Reduces cranial drainage resistance by 25–30% vs supine — free hydraulic boost, zero metabolic cost.',
      protocolId: 'neural-hydraulics-gravity-hack',
    },
    {
      name: 'Breath Modulation (Intracranial Pressure Reset)',
      text: '10 minutes of slow diaphragmatic breathing before sleep: 4s belly inhale / 6s exhale. Creates negative intra-thoracic pressure that assists venous return from the head, lowers pre-sleep intracranial pressure, and activates parasympathetic sleep-onset transition.',
      protocolId: 'neural-hydraulics-breath-modulation',
    },
  ],
}
