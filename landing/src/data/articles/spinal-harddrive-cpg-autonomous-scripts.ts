 ...
 * ID: motor_control_07
 * SEO: central pattern generators CPG, spinal cord motor intelligence, autonomous movement neural efficiency, cognitive offloading movement, spinal cord biohacking.
 */
...
> [ ONDA_STATEMENT ]
> "Your spinal cord is smarter than you think. Stop managing your body like manual legacy software. Update the drivers, hit 'Play,' and let your biological architecture do the rest."
`,
  howToSteps: [
    {
      name: 'Sensory Priming (Feedback Loop Initialization)',
      text: '5 minutes of balance exercises on varied surfaces (foam pad, uneven ground, balance board) before movement sessions. Activates muscle spindles and joint mechanoreceptors, calibrates CPG feedback pathways, and gives the spinal harddrive high-resolution terrain data for autonomous execution.',
      protocolId: 'cpg-sensory-priming',
    },
    {
    ...
    {
      name: 'Eyes-Closed Drills (Cortical Withdrawal Training)',
      text: '2–5 minutes of familiar movements (slow walking, balance holds, basic exercises) with eyes closed per session. Removes visual cortical override, forces autonomous spinal execution, and trains the brain to trust the harddrive — the foundational skill for cognitive offloading during movement.',
      protocolId: 'cpg-eyes-closed-drills',
    },
  ],
}
