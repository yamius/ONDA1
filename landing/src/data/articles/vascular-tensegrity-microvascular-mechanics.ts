...
const article: Article = {
  ...
  introStyle: 'emerald',
  relatedSlugs: ['tensegrity', 'acetylcholine-lens', 'hydraulic-viscosity', 'vagus-nerve', 'ventral-tegmental-area'],
  ...
  imageCaption:
    '[ OXYGEN_BRIDGE_CALIBRATION ]: VENTILATION_ACTIVE. O2_FLOW OPTIMAL. SIGNAL_LATENCY BYPASSED. INTERNAL_MODEL: SYSTEM_COOLING.',
