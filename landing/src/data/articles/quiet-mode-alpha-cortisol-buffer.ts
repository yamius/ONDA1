 ...
 * ID: quiet_mode_06
 * SEO: alpha relaxation cortisol buffer, parasympathetic activation alpha waves, stress resilience protocol, vagal tone alpha rhythm, quiet mode biohacking.
 */
...
`,
  howToSteps: [
    {
      name: 'Exhale Extension (Baroreflex Lever)',
      text: 'Breathe with a 1:2 inhale-to-exhale ratio (4s inhale / 8s exhale or 5:10). Sustain 3–5 minutes. Extended exhale activates the baroreflex via intrathoracic pressure changes, forces parasympathetic dominance, and entrains Alpha via vagus-thalamus-cortex pathway.',
      protocolId: 'quiet-mode-exhale-extension',
    },
    {
      name: 'Peripheral Awareness (Visual Beta Exit)',
      text: 'Soften gaze without moving eyes. Expand awareness to peripheral visual field — notice the edges without looking at them directly. Hold 60–120 seconds combined with exhale extension. Deactivates dorsal attention network and suppresses locus coeruleus Beta drive via dual-axis arousal reduction.',
      protocolId: 'quiet-mode-peripheral-awareness',
    },
    {
      name: 'The Alpha-Drop (Hardware Reset)',
      text: '3 minutes: eyes closed, seated, slight forward head tilt (chin ~10–15° lower). Maintain exhale extension. No agenda. Occipital positioning + reduced sensory load + parasympathetic breathing = hardware-level Alpha trigger. Minimum viable dose for measurable Alpha power increase.',
      protocolId: 'quiet-mode-alpha-drop',
    },
  ],
}
