...
/**
 * Fast vs slow pranayama — the two opposite families: fast (Kapalabhati, Bhastrika) energizes via
 * sympathetic arousal; slow (Nadi Shodhana, Bhramari) calms via parasympathetic/vagal shift. Indian
 * research: cardiovascular calming appears after SLOW not fast; fast drives arousal/alertness. AEO
 * reference, FAQ in ARTICLE_FAQ. Honest: both legitimate, error is using the wrong one; camera=pulse, watch=HRV.
 */
const article: Article = {
  slug: 'fast-vs-slow-pranayama',
  title: 'Fast vs Slow Pranayama: Why Some Breathing Energizes and Some Calms',
  seoTitle: 'Fast vs Slow Pranayama: Energize or Calm | ONDA Life',
  description:
...
**Use slow pranayama to calm and recover:**
- Nadi Shodhana (alternate nostril) — for settling a scattered mind.
- Bhramari (humming) — for calm with a sensory anchor.
...
Interestingly, Indian research has also examined the two families' effects on cognition, since arousal level shapes mental performance. Fast pranayama's alertness can suit tasks needing energy and speed, while slow pranayama's calm supports sustained, steady attention. This mirrors what happens with your nervous system generally: a little activation sharpens you, too much scatters you, and deep calm steadies you. Choosing your breathing pace is, in effect, choosing your mental state — the same lever behind [breathing for focus and attention](/articles/breathing-for-focus-and-attention).
