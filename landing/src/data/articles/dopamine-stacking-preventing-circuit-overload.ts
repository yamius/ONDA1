 ...
 * SEO-optimized for biohacking focus, dopamine baseline, receptor downregulation, glutamate excitotoxicity.
 */
...
VALIDATION_DEVICE: HRV Monitor (Heart Rate Variability)
METRIC: Neural Drive & Focus Duration
...
`,
  howToSteps: [
    ...
    {
      name: "The 'Intermittent Fasting' for Data (Resensitization)",
      text: "90 minutes of 'Zero-Input' per day. No audio, no screens, no exogenous chemicals.",
      protocolId: 'dopamine-stacking-zero-input',
    },
    {
      name: "The 'Cold Shock' Baseline Boost",
      text: '2 minutes of Cold Exposure (3°C - 10°C) to trigger a 250% increase in Dopamine.',
      protocolId: 'dopamine-stacking-cold-shock',
    },
  ],
}
