...
// Sprint 50 — Batch 1 pilots (see landing/docs/content-sprint-50.md)
import zone2CardioArticle from './zone-2-cardio-mitochondrial-bandwidth'
import coldThermogenesisArticle from './cold-thermogenesis-adaptation-curve'
