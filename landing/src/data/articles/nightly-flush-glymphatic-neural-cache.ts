 ...
 * ID: neural_maintenance_01
 * SEO: glymphatic system, deep sleep brain detox, beta-amyloid clearance, neural waste removal, sleep optimization protocol.
 */
...
`,
  howToSteps: [
    {
      name: 'Cooling Patch (N3 Entry Acceleration)',
      text: 'Lower core body temperature 60–90 minutes before sleep: cool shower, room at 18–20°C, remove socks to enable peripheral vasodilation. Temperature drop triggers hypothalamic night-onset signal and accelerates Stage N3 entry.',
      protocolId: 'glymphatic-cooling-patch',
    },
    {
      name: 'Positioning Audit (Drainage Optimization)',
      text: 'Default sleep position: lateral (left or right side). Use a body pillow to maintain position if needed. Lateral positioning reduces glymphatic hydraulic resistance by 25–30% vs supine, enabling complete CSF cache clearance.',
      protocolId: 'glymphatic-lateral-positioning',
    },
    {
      name: 'HRV-Sync (Hydraulic Pump Priming)',
      text: '10–15 minutes of 0.1 Hz resonance breathing (5.0s inhale / 5.0s exhale) 30–60 minutes before sleep. Steadies arterial pulse wave to maximize glymphatic perivascular pressure cycles. Parasympathetic bias variant: 4.0s/6.0s for cortisol clearance.',
      protocolId: 'glymphatic-hrv-sync',
    },
  ],
}
